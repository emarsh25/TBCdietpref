...
### Build the plot
```{r fig1plot, exercise=F, warning = F, message = F, exercise.timelimit = 10000}
...
### Build the plot
```{r fig1plot2, exercise=F, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
### Build the plot
```{r fig1plot3, exercise=F, warning = F, message = F, eval = T, exercise.timelimit = 10000}
